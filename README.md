...
💡 - [Learn how to build your own dotfiles](https://github.com/miagg/dotfiles#your-own-dotfiles)
...
2. [Generate a new public and private SSH key](https://docs.github.com/en/github/authenticating-to-github/generating-a-new-ssh-key-and-adding-it-to-the-ssh-agent) by running:
   ...
   ```zsh
   curl https://raw.githubusercontent.com/miagg/dotfiles/HEAD/ssh.sh | sh -s "<your-email-address>"
   ```
